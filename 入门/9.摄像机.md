...
这里解释一下，在代码中我们的yaw初始值是-90。你可能好奇这个数字是怎么来的。首先我们的初始front是(0,0,-1)。是垂直屏幕向里的一个单位向量对吧，也就是他指向z轴负轴。我们来看一下y轴夹角的计算方式：

![夹角](https://github.com/CodeWicky/Learning-OpenGL/raw/master/%E5%85%A5%E9%97%A8/Pics/9.%E5%A4%B9%E8%A7%92.png)

有了这个坐标系我们就能看懂了，我们指向的是z轴负轴，所以应该旋转-90度。
