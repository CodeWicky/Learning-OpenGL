...
void configVAO(unsigned int * VAO,unsigned int * VBO,unsigned int * EBO) {
    ...
    ///顶点数据
    float vertices[] = {
        0.5,0.5,0.5,0.0,0.0,0.0,0.f,0.f,1.f,
        0.5,-0.5,0.5,1.0,0.0,0.0,0.f,0.f,1.f,
        -0.5,-0.5,0.5,0.0,1.0,0.0,0.f,0.f,1.f,
        
        0.5,0.5,0.5,0.0,0.0,0.0,0.f,0.f,1.f,
        -0.5,-0.5,0.5,0.0,1.0,0.0,0.f,0.f,1.f,
        -0.5,0.5,0.5,0.0,0.0,1.0,0.f,0.f,1.f,
        
        0.5,-0.5,0.5,1.0,0.0,0.0,1.f,0.f,0.f,
        0.5,0.5,-0.5,1,1,1,1.f,0.f,0.f,
        0.5,-0.5,-0.5,0,1,1,1.f,0.f,0.f,
        
        0.5,0.5,0.5,0.0,0.0,0.0,1.f,0.f,0.f,
        0.5,-0.5,0.5,1.0,0.0,0.0,1.f,0.f,0.f,
        0.5,0.5,-0.5,1,1,1,1.f,0.f,0.f,
        
        0.5,-0.5,-0.5,0,1,1,0.f,0.f,-1.f,
        -0.5,-0.5,-0.5,1,0,1,0.f,0.f,-1.f,
        -0.5,0.5,-0.5,1,1,0,0.f,0.f,-1.f,
        
        0.5,0.5,-0.5,1,1,1,0.f,0.f,-1.f,
        0.5,-0.5,-0.5,0,1,1,0.f,0.f,-1.f,
        -0.5,0.5,-0.5,1,1,0,0.f,0.f,-1.f,
        
        -0.5,-0.5,0.5,0.0,1.0,0.0,-1.f,0.f,0.f,
        -0.5,0.5,0.5,0.0,0.0,1.0,-1.f,0.f,0.f,
        -0.5,-0.5,-0.5,1,0,1,-1.f,0.f,0.f,
        
        -0.5,0.5,0.5,0.0,0.0,1.0,-1.f,0.f,0.f,
        -0.5,-0.5,-0.5,1,0,1,-1.f,0.f,0.f,
        -0.5,0.5,-0.5,1,1,0,-1.f,0.f,0.f,
        
        0.5,0.5,0.5,0.0,0.0,0.0,0.f,1.f,0.f,
        -0.5,0.5,0.5,0.0,0.0,1.0,0.f,1.f,0.f,
        0.5,0.5,-0.5,1,1,1,0.f,1.f,0.f,
        
        -0.5,0.5,0.5,0.0,0.0,1.0,0.f,1.f,0.f,
        0.5,0.5,-0.5,1,1,1,0.f,1.f,0.f,
        -0.5,0.5,-0.5,1,1,0,0.f,1.f,0.f,
        
        0.5,-0.5,0.5,1.0,0.0,0.0,0.f,-1.f,0.f,
        0.5,-0.5,-0.5,0,1,1,0.f,-1.f,0.f,
        -0.5,-0.5,-0.5,1,0,1,0.f,-1.f,0.f,
        
        0.5,-0.5,0.5,1.0,0.0,0.0,0.f,-1.f,0.f,
        -0.5,-0.5,0.5,0.0,1.0,0.0,0.f,-1.f,0.f,
        -0.5,-0.5,-0.5,1,0,1,0.f,-1.f,0.f,
    };
    ...
    ///设置顶点属性并激活属性
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 9 * sizeof(GL_FLOAT), (void*)(0 * sizeof(GL_FLOAT)));
